...
namespace KAS
{
	public class DockingPortExMini : PartModule
	{
		...
		[KSPEvent(name = "ContextMenuForcedUndock", active = true, guiActive = true, guiName = "undock forced")]
		public void ContextMenuForcedUndock()
		{
			try
			{
				dock.Decouple();
